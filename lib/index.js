...
class HttpTrace extends MitmProxy {
    ...
    async serializeRequest(request) {
        ...
        this.saveToFile(`${request.id}.http.request`, w.join().toString())
    }
    ...
    async serializeResponse(response) {
        ...
        this.saveToFile(`${response.id}.http.response`, w.join().toString())
    }
    ...
    makeRequestParser(id, subject) {
        ...
        requestParser[kOnHeadersComplete] = function(versionMajor, versionMinor, headers, method, uri, statusCode, statusMessage, upgrade, shouldKeepAlive) {
            this.info = {
                id: id,
                subject: subject,
    ...
    makeResponseParser(id, subject) {
        ...
        responseParser[kOnHeadersComplete] = function(versionMajor, versionMinor, headers, method, uri, statusCode, statusMessage, upgrade, shouldKeepAlive) {
            this.info = {
                id: id,
                subject: subject,
